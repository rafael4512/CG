...
int main(int argc, char const *argv[])
{
    ...
    char *fileXML = strdup("Engine/xmlfiles/file.xml");
    ...
    else if (strcmp("torus",grap) == 0 && argc == 8)
    {
        drawTorus(file, atof(argv[2]), atof(argv[3]), atof(argv[4]), atoi(argv[5]), atoi(argv[6]));
